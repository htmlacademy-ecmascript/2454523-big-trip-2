...
function createEditPointTypePointTemplate (isDisabled) {
...
function createEditPointDestinationOptionTemplate (destinations, isDisabled) {
...
function createEventTypeTemplate (point) {
  ...
  const typeTemplate = createEditPointTypePointTemplate(isDisabled);
...
function createFieldGroupDestinationTemplate (point, destinations) {
  ...
  const destinationTemplate = createEditPointDestinationOptionTemplate(destinations, isDisabled);
